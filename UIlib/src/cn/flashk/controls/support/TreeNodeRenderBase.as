package cn.flashk.controls.support
{
	 ...
	 * 
	 */
	public class TreeNodeRenderBase extends Sprite implements ITreeRender
	{ 
		public static var defaultWidth:Number = 150;
		public static var defaultHeight:Number = 29;
		public static var defaultRenderLinkage:String = "uiSkin.TreeNodeRender";
		...
		public function TreeNodeRenderBase()
		{
			addEvents();
			...
			resetLinkage();
			_ui = ObjectFactory.getNewSprite(_linkage);
		...
		public function set open(valeu:Boolean):void
		{
		...
		{
			_tree.isUserClick = true;
			_tree.selectedTrunkIndex = _trunkIndex;
			_tree.selectedIndex = _index;
		}
		...
		protected function onMouseDown(event:MouseEvent):void
		{
			...
			UIComponent.stage.addEventListener(MouseEvent.MOUSE_UP,onStageMouseUp);
		}
		
		protected function onStageMouseUp(event:MouseEvent):void
		{
			_isDown = false;
			UIComponent.stage.removeEventListener(MouseEvent.MOUSE_UP,onStageMouseUp);
			if(_select == false)
			{
				onMouseOut();
			}
