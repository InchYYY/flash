package cn.flashk.controls
{
	...
	public class Window extends Panel
	{
		...
		public function Window()
		{
			...
			_ableUserDrag = StyleManager.globalAbleUserDragWindow;
		...
		protected function onAddStageInitButton(event:Event):void
		{
			...
			if(UISet.windowCloseButtonTooltip != null && UISet.windowCloseButtonTooltip != ""){
				closeBtn.toolTip = UISet.windowCloseButtonTooltip;
			}
