package cn.flashk.controls.managers
{
	public class UISet
	{
		...
		public static var mobileMouseError:int = 15;
		public static var dragStageMouseAble:Boolean = false;
		public static var windowCloseButtonTooltip:String = "关闭窗口";
		public static var stageScale:Number = 1.0;
		public static var sourceSkinBitmapSmoothing:Boolean = false;
