...
//			closeBtn.toolTip = "关闭消息";
        ...
        {
			if(useMobileAlert == true){
				MobileAlert.show(text,parentContainer,closeFunction,title,icon,buttonLabels,isUnableMouse,alertWidth);
				return null;
			}
            ...
            if (isUnableMouse == true)
            {
                ...
                mark.graphics.drawRect (-500 , -500 , 4340 , 2660);
