package cn.flashk.controls
{
	...
	{
		public static var defaultWidth:int = 120;
		public static var defaultHeight:int = 21;
		...
		protected function open_list(event:MouseEvent=null):void
		{
			...
			UIComponent.popUpAddParent.addChild(_list);
			...
			if(UIComponent.popUpAddParent == UIComponent.stage){
				
			}else{
				po.x = po.x / UIComponent.popUpAddParent.scaleX;
				po.y = po.y / UIComponent.popUpAddParent.scaleY;
			}
			_list.x=int(po.x);
			_list.y=po.y;
