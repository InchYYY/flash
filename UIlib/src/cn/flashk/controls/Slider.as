package cn.flashk.controls
{
	...
	public class Slider extends UIComponent
	{
		...
		public function get isUserOperateNow():Boolean
		{
			return _isUserOperateNow;
		}

		public function set isUserOperateNow(value:Boolean):void
		{
			_isUserOperateNow = value;
		}
		...
		public function set value(num:Number):void{
			var a:Number = (num-minimum)/(maximum-minimum);
			_value = num;
			if(a>1) a = 1;
			if(a<0) a=0;
		...
		*/
		...
		private var _isUserOperateNow:Boolean = false;
		protected function startDragSlider(event:MouseEvent):void
		{
			_isUserOperateNow = true;
		...
		public var dragingFunction:Function;
