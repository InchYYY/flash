package ui.guider
{
	...
	public class GuiderGlow
	{
		private static const _repeatMax: int = 1;
	...
	//		{ alpha: 1.0, blur: 32 }
		...
		public function GuiderGlow(color: uint = 0xff0000)
		{
			_color = color;
		}
	...
	/*	public function startMouseEvent(): void
		...
		private function countGlow(): void
		{
			...
			stop();
			init();
			if (_onGlowFinished != null) {
				_onGlowFinished();
			//	G.dbg("_onGlowFinished()");
			}
		}
	}
}
