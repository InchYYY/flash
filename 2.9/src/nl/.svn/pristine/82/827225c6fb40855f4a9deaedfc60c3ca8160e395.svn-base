///////////////////////////////////////////////////////////
//  Mouth.as
//  Macromedia ActionScript Implementation of the Class Mouth
...
package nl.funnymessages.overlay.head
{
	...
	public class Mouth extends Sprite
	{
		...
		public function Mouth(){
			Debug.addClass('Mouth');
			Debug.traceInfo('Mouth', 'constructor');
			m_oImage = null;
		...
		public function createImage(p_oHeadImage:DisplayObject, p_aMarkers:Array):void {
			...
			var shpMarker:Shape;
			Debug.traceInfo('Mouth', 'createImage', 'markers', p_aMarkers);
			// look for the mouth markers
			for each (var oMarker:Object in p_aMarkers) {
				if (undefined != oMarker.type) {
					switch (oMarker.type) {
						case Head.MARKER_MOUTH_LEFT : 
							pntMouthLeft = new Point(oMarker.x, oMarker.y);
						break;
						case Head.MARKER_MOUTH_RIGHT : 
							pntMouthRight = new Point(oMarker.x, oMarker.y);
						break;
						case Head.MARKER_MOUTH_BOTTOM : 
			...
			if ((null != pntMouthLeft) && (null != pntMouthRight) && (null != pntMouthBottom)) {
				...
				Debug.traceInfo('Mouth', 'createImage', 'not all mouth markers available');
			}
		}
		...
		{
			Debug.traceInfo('Mouth', 'say', 'phonem', p_sPhonem);
			if (null != m_oImage) {
