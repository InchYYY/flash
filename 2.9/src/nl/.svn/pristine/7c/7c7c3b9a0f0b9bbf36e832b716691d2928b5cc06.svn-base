package nl.bron
{
	...
	public class HostCell extends EventDispatcher
	{
		...
		private var _isReFilers:Boolean;
		public function get initFilters():Array{ return _filters }
		public function set initFilters(arrfilter:Array):void{ if(_isReFilers)return;_filters = arrfilter; _isReFilers = true;}
		
		public function get filtersName():String{ return _resource.filtersName }
		public function set filtersName(name:String):void{ _resource.filtersName = name;Filters.setFilter(_actCell,filtersName);}
		...
		public function set actCell(p: brCell): void { _actCell = p; initFilters = p.filters;}
