package nl.comm
{
	...
	public class LoadManageFx extends EventDispatcher
	{
		...
		private var self : LoadManageFx;

		public function LoadManageFx()
		{
			self = this;
			mcs = new Array();
			ls = new Array();
		...
		public function Load(mc : mLoad, o : int) : void
		{
			...
			{
				act.load();
				act.loader.contentLoaderInfo.addEventListener(Event.COMPLETE, function (evt:Event) : void {
					Load(null, 0);
				});
