package debug
{
	...
	public class DebugExternal
	{
		...
		public static function callJavaScript(functionName:String,...args):*
		{
			if(Capabilities.playerType == "StandAlone") return false;
			return ExternalInterface.call(functionName, args);
		}
		
		public static function alertMessage(...args):Boolean
		{
			if(Capabilities.playerType == "StandAlone") return false;
		...
		{
			if(Capabilities.playerType == "StandAlone") return;
