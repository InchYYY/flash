package  UtilsTool.timeUtils
{
	/**@author xuechong
	 * @date 2010.08.17
	 * var tempDateArray:Array = GreToLunarDate.greToLunarArray(2010, 8, 17);
	 * */
	public class GreToLunarDate
	{
		public function GreToLunarDate()
		{
		...
		public static function greToLunarArray(greYear:int, greMonth:int, greDay:int):Array
		{
			...
			{
				if(leap > 0 && i == (leap + 1) && nongDate[6] == 0)    //闰月
				{
					i--;
					nongDate[6] = 1;
		...
		public static var lunarInfoArr:Array = [
